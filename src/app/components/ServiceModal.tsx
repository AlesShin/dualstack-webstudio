...
const serviceDetails: Record<string, {
  ...
  'Разработка сайтов': {
    fullDescription: 'Создаем современные сайты и веб-приложения с понятной структурой, адаптивным интерфейсом и технической базой для дальнейшего развития.',
    features: [
  ...
  'Веб-дизайн': {
    fullDescription: 'Разрабатываем дизайн, который отражает характер бренда, помогает пользователю быстрее разобраться в продукте и аккуратно ведет к целевому действию.',
    features: [
      'UX/UI исследования',
      'Создание прототипов',
  ...
  'SEO оптимизация': {
    fullDescription: 'Комплексная SEO-оптимизация: техническая база, структура страниц, семантика, контентные рекомендации и понятная отчетность по изменениям.',
    features: [
  ...
  'Мобильная адаптация': {
    fullDescription: 'Адаптируем сайт под основные типы устройств - от смартфонов до планшетов и десктопов.',
    features: [
      'Responsive дизайн',
  ...
  'Высокая скорость': {
    fullDescription: 'Оптимизируем производительность сайта, чтобы страницы загружались быстрее и пользователю было удобнее работать с интерфейсом.',
    features: [
  ...
  'Безопасность': {
    fullDescription: 'Настраиваем базовую защиту сайта, обновления, резервное копирование и мониторинг уязвимостей.',
    features: [
      'SSL сертификаты',
      'Защита от DDoS',
      'Безопасность данных',
