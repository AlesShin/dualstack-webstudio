...
- Редизайн под конверсию: от 54 900 ₽.
- Пакет Рост 90: от 89 000 ₽ (сайт + SEO + контент-план).
...
const SEO_OFFERS: OfferSnapshot[] = [
  { title: 'В Яндекс', price: 'от 35 000 ₽/мес', bestFor: 'рост позиций в Яндексе и локальном поиске' },
  { title: 'В Google', price: 'от 40 000 ₽/мес', bestFor: 'поисковый трафик и коммерческие запросы' },
  { title: 'В топ-10', price: 'от 55 000 ₽/мес', bestFor: 'комплексное продвижение по ключевым запросам' },
];
...
const BRANDING_OFFERS: OfferSnapshot[] = [
  ...
  { title: 'Маркетинговые коммуникации', price: 'от 75 000 ₽', bestFor: 'рост узнаваемости и рекламная подача' },
];

const PROMO_OFFERS: OfferSnapshot[] = [
  { title: 'Старт бизнеса', price: 'от 39 900 ₽', timeline: 'до 10 дней', bestFor: 'быстрый выход в онлайн' },
  { title: 'Редизайн под конверсию', price: 'от 54 900 ₽', timeline: '2-4 недели', bestFor: 'обновление текущего сайта и рост заявок' },
  { title: 'Пакет Рост 90', price: 'от 89 000 ₽', timeline: '90 дней', bestFor: 'сайт + SEO + контент-план для стабильного роста' },
];
...
В каждом пакете: аудит, сбор семантики, техоптимизация и регулярная отчётность.`,
          `Если рынок конкурентный, обычно эффективнее стартовать с комплексного пакета «В топ-10» (от 55 000 ₽/мес).
...
Если опишете задачу, подскажу, где максимальная выгода.`,
          `В разделе «Акции» есть готовые пакетные решения для быстрого старта и роста.
Чаще всего для нового бизнеса выбирают «Старт бизнеса», для действующих сайтов — «Редизайн под конверсию».`,
          `Могу подобрать акцию под ваш сценарий:
• запуск с нуля,
• усиление текущего сайта,
• рост SEO и контента на 90 дней.`,
        ],
        seed,
      ),
      handoff: false,
